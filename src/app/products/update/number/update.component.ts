...
@Component({
  selector: 'update-product-number',
  standalone: true,
  imports: [CommonModule, FormsModule],
  templateUrl: './update.component.html',
})
export class ModalUpdateProductNumber {
  data: any;
  //
  ...
  isDisabledSaveButton() {
    return !(this.newName.length > 0 && this.data.number != this.newName);
  }
  onSave() {
    this.addConfirm();
  }
  ...
  add() {
    ...
    const data3 = {
      ...
      inputProductNumber: this.newName,
    };
